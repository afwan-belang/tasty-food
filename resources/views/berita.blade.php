...
<section class="py-24 px-6 lg:px-24 bg-gray-50 select-none">
    <div class="max-w-7xl mx-auto">
        @if($featuredNews)
        <div data-id="{{ $featuredNews->id }}" onclick="openFoodModal(this.dataset.id)" class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24 bg-white rounded-3xl p-6 lg:p-10 shadow-xl border border-gray-100 reveal-on-scroll cursor-pointer group">
