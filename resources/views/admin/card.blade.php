        ...
        <table class="w-full text-left border-collapse min-w-[750px]">
            <thead>
                <tr class="bg-gray-50/80 border-b border-gray-100 text-[10px] font-black tracking-wider text-gray-400 uppercase">
                    ...
                    <th class="py-5 px-6">NAMA KONTEN & DESCRIPTION</th>
            ...
            <tbody class="divide-y divide-gray-100 text-sm">
                ...
                @empty
                    <tr>
                        <td colspan="3" class="text-center py-16 text-xs font-black text-gray-400 tracking-widest uppercase bg-white">Belum ada data komponen Card terdaftar.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
